...
function toDallE3Request(request) {
  ...
  const options = {
    ...
    size: (_b = (_a = request.config) == null ? void 0 : _a.custom) == null ? void 0 : _b.size,
    style: (_d = (_c = request.config) == null ? void 0 : _c.custom) == null ? void 0 : _d.style,
    user: (_f = (_e = request.config) == null ? void 0 : _e.custom) == null ? void 0 : _f.user,
    quality: (_h = (_g = request.config) == null ? void 0 : _g.custom) == null ? void 0 : _h.quality,
    response_format: ((_j = (_i = request.config) == null ? void 0 : _i.custom) == null ? void 0 : _j.response_format) || "b64_json"
  };

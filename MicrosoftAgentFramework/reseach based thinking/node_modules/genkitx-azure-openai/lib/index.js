...
const azureOpenAI = (options) => (0, import_plugin.genkitPlugin)("azure-openai", (ai) => __async(void 0, null, function* () {
  const client = new import_openai.AzureOpenAI(options);
  ...
  for (const name of Object.keys(import_embedder.SUPPORTED_EMBEDDING_MODELS)) {
    (0, import_embedder.openaiEmbedder)(ai, name, client);
  }
}));
